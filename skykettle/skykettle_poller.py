...
REQUIREMENTS = ['bluepy==1.1.4', 'pygatt==3.2.0', 'btlewrap==0.0.3']
...
from skykettle import exceptions
...
class SkyKettlePoller:
    """"
    A class to read data from SkyKettle sensors.
    """
    ...
    def __init__(self, mac):
        """
        Initialize a SkyKettle Poller for the given MAC address.
        """

        key = b'\xff\xff\xff\xff\xff\xff\xff\xff'
        self.connection = btle.Peripheral(deviceAddr=mac, addrType=btle.ADDR_TYPE_RANDOM)
